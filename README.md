...
Wrapper for the keyless scraped api (scrapi) endpoints of the CoinMarketCap website.
...
## [XFCR](https://github.com/Ran-n/coinmarketcap_scrapi/blob/main/doc/xFCR/indekso.md)
### Actual (v1.1)
